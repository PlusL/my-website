...
<div id="wrapper">
    ...
    <div id="form-construct-field">
        <div id="form-title">
            <h3><input type="text" value="求是潮社团纳新报名表" class="title edit"  /><button value="push" onclick="ShowCookie()"></button></h3>
        </div>
        <div id="form-intro">
...
function onshow(obj)
{
	obj.document.classname="q-fieled"
	}
</script>-->
